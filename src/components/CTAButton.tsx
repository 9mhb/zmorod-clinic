...
const variantStyles: Record<Variant, string> = {
  ...
  outline:
    "bg-transparent border-2 border-brand-600 text-brand-600 hover:bg-brand-50",
  whatsapp:
...
export function CTAButton({
  ...
  const link = href || WHATSAPP_LINK;
  const isWhatsApp = link.includes("wa.me") || variant === "whatsapp";

  const baseClasses =
    "inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-200 hover:scale-[1.02]";
